        ...
        <div className='pb-5'>
            <div className='flex justify-between items-center'>
                ...
                <div className='relative py-2 group'>
                    ...
                    <div className='absoulute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block'>
                        <p onClick={()=>navigate('/profile')} className='cursor-pointer text-sm'>Edit Profile</p>
                        <hr className='my-2 border-t board-gray-500' />
